...
import com.example.jonathandorvilier.newyorktimesearch.ArticleArrayAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    public void onArticleSearch(View view) {
       ...
       // Toast.makeText(this,"Searching for" + query, Toast.LENGTH_LONG).show();
        ...
        params.put("api-key", "227c750bb7714fc39ef1559ef1bd8329"); //227c750bb7714fc39ef1559ef1bd8329
        params.put("page",0);
        params.put("q", query);
